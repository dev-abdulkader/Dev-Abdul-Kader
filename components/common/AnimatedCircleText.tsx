...
//         <GoArrowDownRight className="text-white text-6xl" />
//       </div>
//       <div className="absolute w-full h-full text-white text-[17px] font-mono flex items-center justify-center">
...
const CustomArrow = () => {
  return (
    <button
      className="button  text-white rounded-full cursor-pointer gap-2 transition-all duration-300
    ...
    >
      <span className="svg items-center sm:flex py-10 rotate-45">
        <svg
          ...
          height="30" // increased from 20 to 40
          viewBox="0 0 38 15"
          fill="none"
        >
          <path
...
const AnimatedCircleText: React.FC = () => {
  const text = "About - Projects - Experiences - ";
